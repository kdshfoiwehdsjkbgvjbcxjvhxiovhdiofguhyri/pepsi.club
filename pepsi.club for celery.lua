...
local retardarmschams = Color3.fromRGB(255, 0, 0)
...
UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(112, 112, 112))}
UIGradient.Rotation = 90
...
local function spectlist()
	...
	while wait(0.05) do
		...
		for i,v in next, GetSpectators() do
			...
			new.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
...
local ebtxt = Drawing.new("Text");ebtxt.Text = "EB";ebtxt.Center = true;ebtxt.Outline = true;ebtxt.Color = Color3.fromRGB(255, 255, 255);ebtxt.Font = 3;ebtxt.Position = Vector2.new(currentCamera.ViewportSize.X / 2, currentCamera.ViewportSize.Y - 80);ebtxt.Size = 18;ebtxt.Visible = false;
local ebcounter = Drawing.new("Text");ebcounter.Text = "eb: "..ebcount.."";ebcounter.Center = true;ebcounter.Outline = true;ebcounter.Color = Color3.fromRGB(255, 255, 255);ebcounter.Font = 3;ebcounter.Position = Vector2.new(currentCamera.ViewportSize.X / 2, currentCamera.ViewportSize.Y - 50);ebcounter.Size = 18;ebcounter.Visible = false
local VelocityCounter = Drawing.new("Text");VelocityCounter.Text = "";VelocityCounter.Center = true;VelocityCounter.Outline = true;VelocityCounter.Color = Color3.new(1,1,1);VelocityCounter.Font = 3;VelocityCounter.Position = Vector2.new(currentCamera.ViewportSize.X/2, currentCamera.ViewportSize.Y-70);VelocityCounter.Size = 20;VelocityCounter.Visible = false
------------------------------------ MAIN FUNCS ------------------------------------
...
local esp = {
    ...
    settings = {
        ...
        boxfill = {enabled = false, color = Color3.fromRGB(255, 0, 0), transparency = 0.5},
...
esp.NewPlayer = function(v)
    esp.playerObjects[v] = {
        ...
        boxOutline = esp.NewDrawing("Square", {Color = Color3.fromRGB(0, 0, 0), Thickness = 3, ZIndex = 2}),
        box = esp.NewDrawing("Square", {Color = Color3.fromRGB(255, 255, 255), Thickness = 1, ZIndex = 3}),
        boxfill = esp.NewDrawing("Square", {Color = Color3.fromRGB(255, 255, 255), Thickness = 1, ZIndex = 1}),
...
as_fov_circleout1.Color = Color3.fromRGB(0, 0, 0)
...
as_fov_circle.Color = Color3.fromRGB(54, 57, 241)
...
as_fov_circleout2.Color = Color3.fromRGB(0, 0, 0)
...
br_fov_circleout1.Color = Color3.fromRGB(0, 0, 0)
...
br_fov_circle.Color = Color3.fromRGB(54, 57, 241)
...
br_fov_circleout2.Color = Color3.fromRGB(0, 0, 0)
...
local function getPositionOnScreen(Vector)
    local Vector3, OnScreen = currentCamera.WorldToScreenPoint(currentCamera, Vector)
    return Vector2.new(Vector3.X, Vector3.Y), OnScreen
end
...
Toggles.br_fov:AddColorPicker('br_fovcolor', {Default = Color3.fromRGB(255,255,255), Title = 'FOV Circle Color'})
...
Toggles.as_fov:AddColorPicker('as_fovcolor', {Default = Color3.fromRGB(255,255,255), Title = 'FOV Circle Color'})
...
Toggles.espbox:AddColorPicker('espboxcolor', {Default = Color3.fromRGB(255,255,255), Title = 'Box Color'})
...
Toggles.espnames:AddColorPicker('espnamescolor', {Default = Color3.fromRGB(255,0,0), Title = 'Names Color'})
...
Toggles.espboxfill:AddColorPicker('espboxfillcolor', {Default = Color3.fromRGB(255,0,0), Title = 'Box Fill Color'})
...
Toggles.espht:AddColorPicker('esphtcolor', {Default = Color3.fromRGB(0,255,0), Title = 'Health Text Color'})
...
Toggles.espdistance:AddColorPicker('espdistancecolor', {Default = Color3.fromRGB(255,255,255), Title = 'Distance Color'})
...
selfchmams:AddColorPicker('selfchams_fill', {Default = Color3.fromRGB(0, 0, 255), Title = 'Fill Color'})
selfchmams:AddColorPicker('selfchams_outline', {Default = Color3.fromRGB(0, 0, 0), Title = 'Outline Color'})
-- // Camera Tab
...
CamTab:AddLabel('Aura Color'):AddColorPicker('cam_smokeauracolor', {Default = Color3.fromRGB(255, 0, 0), Title = 'Smoke Aura Color'})
-- // Viewmodel Tab
...
ambienttog:AddColorPicker('wrl_ambient1', {Default = Color3.fromRGB(75, 58, 222), Title = 'Ambient'})
ambienttog:AddColorPicker('wrl_ambient2', {Default = Color3.fromRGB(109, 58, 206), Title = 'Outdoor'})
...
mespbombtog:AddColorPicker('mesp_bombcolor', {Default = Color3.fromRGB(255, 0, 0), Title = 'Color'})

local mespweapontog = MiscESPTab:AddToggle('mesp_weapons', {Text = 'Weapon', Default = false})
mespweapontog:AddColorPicker('mesp_weaponscolor', {Default = Color3.fromRGB(88, 124, 220), Title = 'Color'})
-- // Visuals Misc Tab
...
MiscTab:AddLabel('Color'):AddColorPicker('misc_mollycolor', {Default = Color3.fromRGB(255, 0, 0), Title = 'Molly Color'})
...
armschamstog:AddColorPicker('arms_armschamscolor', {Default = Color3.fromRGB(255, 0, 0), Title = 'Arm Color'})
...
weaponchamstog:AddColorPicker('arms_weaponchamscolor', {Default = Color3.fromRGB(255, 0, 0), Title = 'Arm Color'})
...
BulletsTab:AddLabel('Tracer Color'):AddColorPicker('bullets_btcolor', {Default = Color3.fromRGB(255, 0, 0), Title = 'Tracer Color'})
...
BulletsTab:AddLabel('Impact Color'):AddColorPicker('bullets_impactenabledcolor', {Default = Color3.fromRGB(0, 0, 255), Title = 'Impact Color'})
...
BulletsTab:AddLabel('Hit Color'):AddColorPicker('bullets_hitcolor', {Default = Color3.fromRGB(0, 0, 255), Title = 'Hit Color'})
...
--------------------------------------------------------------------------------------
MiscSec1:AddToggle('misc_watermark', {Text = 'Watermark', Default = false}):AddColorPicker('misc_watermarkcolor', {Default = Color3.fromRGB(2, 103, 172), Title = 'Watermark Color'})
...
MiscSec1:AddToggle('misc_spectlist', {Text = 'Show Spectators List', Default = false}):AddColorPicker('misc_spectlistcolor', {Default = Color3.fromRGB(2, 103, 172), Title = 'List Color'})
...
Toggles.mov_keystrokes:AddColorPicker('mov_keystrokescolor', {Default = Color3.fromRGB(255, 255, 255), Title = 'Keystrokes Color'})
...
MiscSec2:AddToggle('mov_graph', {Text = 'Velocity Graph', Default = false}):AddColorPicker('mov_graphcolor', {Default = Color3.fromRGB(255, 255, 255), Title = 'Graph Color'})
Toggles.mov_graph:OnChanged(function()
    while Toggles.mov_graph.Value do wait()
        local normalY = currentCamera.ViewportSize.Y-90
        local velocity = IsAlive(localPlayer) and math.floor(math.clamp((localPlayer.Character.HumanoidRootPart.Velocity * Vector3.new(1,0,1)).magnitude*14.85,0,400)) or 0
        if Toggles.mov_graph.Value then
            local width = 2
            local line = Drawing.new("Line")
            table.insert(graphLines, line)
            line.From = Vector2.new(currentCamera.ViewportSize.X/2 + 98, lastPos)
            line.To = Vector2.new(currentCamera.ViewportSize.X/2 + 100, normalY - (velocity/6.5))
            line.Thickness = 1
            line.Transparency = 1
...
MiscSec4:AddToggle('hit_hitmarker', {Text = 'Hit Marker', Default = false}):AddColorPicker('hit_hitmarkercolor', {Default = Color3.fromRGB(255, 255, 255), Title = 'Hit Marker Color'})
...
-- // HOOKS :SUNGLASSES:
print("sorry i deleted all hooks")
...
workspace.ChildAdded:Connect(function(new)
    if new.Name == "C4" and new:IsA("Model") and Toggles.mesp_bomb.Value == true then
		...
		TextLabelText.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
		TextLabelText.TextSize = 14
		TextLabelText.TextYAlignment = Enum.TextYAlignment.Top
		...
		TextLabelBombTimer.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
...
local function ESP()
    for i,v in pairs(esp.playerObjects) do
        ...
        if esp.HasCharacter(i) then
            ...
            local BoxFillSize = Vector2.new(math.floor(Size * 1.5), math.floor(Size * 1.9)) --same as box
            local BoxFillPos = Vector2.new(math.floor(Vector.X - Size * 1.5 / 2), math.floor(Vector.Y - Size * 1.6 / 2)) -- this 1 too
    ...
    if Toggles.mov_bhop.Value then
        if localPlayer.PlayerGui.GUI.Main.GlobalChat.Visible == false then
            if IsAlive(localPlayer) and userInput:IsKeyDown(Enum.KeyCode.Space) then
                ...
                move = userInput:IsKeyDown(Enum.KeyCode.D) and move + Vector3.new(-dir.Z,0,dir.X) or move
                move = userInput:IsKeyDown(Enum.KeyCode.A) and move + Vector3.new(dir.Z,0,-dir.X) or move
    ...
    if IsAlive(localPlayer) then
        ...
        if Toggles.mov_edgebug.Value and not ebCooldown and isButtonDown(Enum.KeyCode[Options.mov_edgebugbind.Value]) and IsAlive(localPlayer) then
            if oldState == Enum.HumanoidStateType.Freefall and currentState == Enum.HumanoidStateType.Landed then
                ...
                wait()
                localPlayer.Character.HumanoidRootPart.Velocity *= Vector3.new(1.8,5,1.8) -- Vector3.new(1.8,1,1.8)
                spawn(function()
